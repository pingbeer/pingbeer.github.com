...
var refresher = {
	...
	scrollIt: function(parameter, pullDownEl, pullDownOffset, pullUpEl, pullUpOffset) {
		...
		pullDownEl.querySelector('.pullDownLabel').innerHTML = window.mg_online === true ? refresher.info.pullDownLable : refresher.info.onlineFalse;
	...
	onScrolling: function(e, pullDownEl, pullUpEl, pullUpOffset) {
		...
		if (e.y > 0) {
			...
			pullDownEl.querySelector('.pullDownLabel').innerHTML = window.mg_online === true ? refresher.info.pullingDownLable : refresher.info.onlineFalse;
			e.minScrollY = 0;
		}
	...
	onPulling: function(pullDownEl, pullDownAction, pullUpEl, pullUpAction) {
		if (pullDownEl.className.match('flip') /*&&!pullUpEl.className.match('loading')*/ ) {
			...
			pullDownEl.classList.remove("flip");
			pullDownEl.querySelector('.pullDownLabel').innerHTML = window.mg_online === true ? refresher.info.loadingLable : refresher.info.onlineFalse;
