...
(function( window, undefined ) {
	...
	function EasyJsDomUtil() {
		...
		/*
		 * 装载xml数据列表至DomNode
		 * @param args.dataListXml : listDataXml
		 * @param args.dataXmlNodeName: dataXml节点名
		 * @param args.dataListDomNode : List的Dom节点
		 * @param args.dataDomNodeCopy : List的Dom节点下的Data节点的拷贝，作为复制的源
		 * @param args.domNodeAttrName : Dom节点下的attribute名，用于扫描过滤
		 * @param args.dataNodeDidLoadFunc : List中的节点数据装载完成后的回调函数，在循环装载Data节点时，每个节点调用一次.
