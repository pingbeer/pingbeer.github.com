	...
	function initEvents() {
		...
		$items.each( function() {
			...
			var $item = $( this ),
				...
				//$iframe = $item.find(".rb-week");
					
			$item.on( 'click', function() {
				window.location.href=$overlay.attr("da-href");
//$iframe.html('<iframe border="0" id="content" src="http://taobao.com" frameborder="0" height="100%" width="100%"></iframe>');
