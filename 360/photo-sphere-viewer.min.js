 ...
 */
!function (a, b) {
    "function" == typeof define && define.amd ? define(["three", "d.js", "uevent", "dot/doT"], b) : "object" == typeof module && module.exports ? module.exports = b(require("three"), require("d.js"), require("uevent"), require("dot/doT")) : a.PhotoSphereViewer = b(a.THREE, a.D, a.uEvent, a.doT)
    ...
    c.mixin(e), e.prototype._loadXMP = function (a) {
        ...
        var b = new a.SphereGeometry(e.SPHERE_RADIUS, e.SPHERE_VERTICES, e.SPHERE_VERTICES, (-x.HalfPI)), c = new a.MeshBasicMaterial({
            side: a.DoubleSide,
            overdraw: e.SYSTEM.isWebGLSupported && this.config.webgl ? 0 : 1
        });
        this.mesh = new a.Mesh(b, c), this.mesh.scale.x = -1, this.mesh.rotation.z = this.config.panorama_roll, this.scene.add(this.mesh)
        ...
        var d = this, f = new a.SphereGeometry(.9 * e.SPHERE_RADIUS, e.SPHERE_VERTICES, e.SPHERE_VERTICES, (-x.HalfPI)), g = new a.MeshBasicMaterial({
            side: a.DoubleSide,
            overdraw: e.SYSTEM.isWebGLSupported && this.config.webgl ? 0 : 1,
            map: b,
            transparent: !0,
        ...
        if (h.scale.x = -1, c) {
            ...
            var i = new a.Vector3(0, 1, 0).cross(this.camera.getWorldDirection()).normalize(), j = (new a.Quaternion).setFromAxisAngle(i, c.latitude - this.prop.latitude);
        ...
        if (this.prop.zooming) {
            ...
            }], c = Math.sqrt(Math.pow(b[0].x - b[1].x, 2) + Math.pow(b[0].y - b[1].y, 2)), d = 80 * (c - this.prop.pinch_dist) / this.prop.size.width;
    ...
    }, e.prototype.resize = function (a) {
        a.width && (this.container.style.width = a.width), a.height && (this.container.style.height = a.height), this._onResize()
        ...
        var b = (a.x + this.prop.pano_data.cropped_x) / this.prop.pano_data.full_width * x.TwoPI, c = (a.y + this.prop.pano_data.cropped_y) / this.prop.pano_data.full_height * Math.PI;
        return {longitude: b >= Math.PI ? b - Math.PI : b + Math.PI, latitude: x.HalfPI - c}
    }, e.prototype.sphericalCoordsToTextureCoords = function (a) {
        if (this.prop.isCubemap)throw new v("Unable to use texture coords with cubemap.");
        var b = a.longitude / x.TwoPI * this.prop.pano_data.full_width, c = a.latitude / Math.PI * this.prop.pano_data.full_height;
        return {
        ...
        var d = this.psv.prop.direction.clone().normalize(), f = (new a.Vector3).crossVectors(b, c).normalize(), g = (new a.Vector3).crossVectors(f, b).normalize(), h = (new a.Vector3).addVectors(b.clone().multiplyScalar(-d.dot(g)), g.clone().multiplyScalar(d.dot(b))).normalize(), i = (new a.Vector3).crossVectors(h, d);
    ...
    },i.prototype.getNavbarButton = function (a, b) {
        var c = null;
        return this.items.some(function (b) {
            if (b.id === a)return c = b, !0
        }), c || b || console.warn('PhotoSphereViewer: button "' + a + '" not found in the navbar.'), c
        ...
        c.className = "psv-zoom-button-plus", c.title = this.psv.config.lang.zoomIn,
        ...
        this._dynamicSize = !0, this.svgStyle ? Object.getOwnPropertyNames(this.svgStyle).forEach(function (a) {
            ...
            if (a && "object" != typeof a[0])for (var b = 0; b < a.length; b++)a.splice(b, 2, [a[b], a[b + 1]])
                ...
                return [x.parseAngle(a[0]), x.parseAngle(a[1], !0)]
    ...
    return e.Utils = x, x.TwoPI = 2 * Math.PI, x.HalfPI = Math.PI / 2, x.svgNS = "http://www.w3.org/2000/svg", x.checkTHREE = function (b) {
        ...
        if ("string" == typeof b) {
            b = b.toString().trim();
            var c = parseFloat(b.replace(/^(-?[0-9]+(?:\.[0-9]*)?).*$/, "$1")), d = b.replace(/^-?[0-9]+(?:\.[0-9]*)?(.*)$/, "$1").trim();
        ...
        return b = (c ? b + Math.PI : b) % x.TwoPI, b < 0 && (b = x.TwoPI + b), c ? x.bound(b - Math.PI, -x.HalfPI, x.HalfPI) : b
